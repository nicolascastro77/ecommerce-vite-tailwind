...
export default function ProductDetail() {
    const { isProductDetailOpen, closeModal, productToShow } = useContext(ShoppingCartContext)
      ...
      <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50">
        <div className="bg-white p-6 rounded-md max-w-2xl flex flex-col md:flex-row relative">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-blue-500 text-lg font-bold mb-2">${productToShow.price}</p>
            <div className="mb-4">
